	...
	class Louis_Pagination
{
    ...
    {   
        ...
        if ($this->_config['total_record'] > $this->_config['limit'])
        {
            ...
            if ($this->_config['current_page'] > 1)
            {
                $p .= '<li><a href="'.$this->__link('1').'">Trang đầu</a></li>';
                $p .= '<li><a href="'.$this->__link($this->_config['current_page']-1).'">Trang trước</a></li>';
            }
            ...
            for ($i = $this->_config['min']; $i <= $this->_config['max']; $i++)
            {
                ...
                if ($this->_config['current_page'] == $i){
                    $p .= '<li class="active"><span class="page-numbers current">'.$i.'</span></li>';
                }
                else{
            ...
            if ($this->_config['current_page'] < $this->_config['total_page'])
            {
                $p .= '<li><a href="'.$this->__link($this->_config['current_page'] + 1).'">Trang sau</a></li>';
                $p .= '<li><a href="'.$this->__link($this->_config['total_page']).'">Trang cuối</a></li>';
            }
